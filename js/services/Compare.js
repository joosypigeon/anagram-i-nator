...
app.factory('compare', ['wordData', '$timeout', 'filterFilter', 'MAX_WORD_LENGTH', 'MAX_LETTERS', function (wordData, $timeout, filterFilter, MAX_WORD_LENGTH, MAX_LETTERS) {
    ...
    function strictLetterFilter(x, i) {
        ...
        return isLetter && count <= MAX_LETTERS;
    }
    ...
    function lengthFilter(x) {
        ...
        return !isLetter || (count <= MAX_LETTERS && isLetter);
    }
    ...
    return {
        ...
        updateWords: function updateWords(scope, firstOrSecond) {
            var unmatched = (firstOrSecond === 'first' ? firstUnmatched : secondUnmatched);
